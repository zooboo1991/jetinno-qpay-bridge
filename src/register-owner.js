...
export async function registerOwner({
  ...
  // One transaction: a failure between these inserts used to leave a half
  // registered owner — an owners row whose merchant fingerprint already
  // exists, blocking every re-registration attempt with
  // MERCHANT_ALREADY_REGISTERED until someone cleans up by hand.
  await tx(async (q) => {
    await q(
